...
def is_room_free_at(start_date, end_date):
    ...
    json_data = json.dumps({'start_date': start_date, 'end_date': end_date, 'rfid_reader_id':DEFAULT_RFID_ID})
...
def reserve_room(start_date, end_date, organizer_card_id):
    json_data = json.dumps({'start_date': start_date, 'end_date': end_date, 'organizer_card_id': organizer_id})

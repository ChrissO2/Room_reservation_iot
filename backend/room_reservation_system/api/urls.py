...
urlpatterns = [
    ...
    path('meetings/upcoming/', views.upcoming_meetings),
    path('meetings/current/', views.current_meetings),
    path('meetings/report/', views.meetings_last_30_days_view),
    path('rooms/report/', views.room_report_view),
